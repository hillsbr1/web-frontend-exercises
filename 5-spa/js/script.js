...
var aboutPageUrl = "snippets/about-snippet.html";
...
function buildAndShowAboutHTML (aboutHtml) {
  var numStars = randomRating();
  console.log("stars = " + numStars);
  var aboutHtmlToInsertIntoMainPage = "<section class='row'><span class='fa fa-star'></span>";
  numStars--;
  for(var i=1; i<5; i++) { // 4 times
    if (numStars > 0) {
      // filled star
      aboutHtmlToInsertIntoMainPage += "<span class='fa fa-star'></span>";
      numStars--;
    } else {
      // empty star
  ...
  aboutHtmlToInsertIntoMainPage += "</section>";
